window.addEventListener("DOMContentLoaded",()=>{gsap.registerPlugin(ScrollTrigger),$(".reviews-slider").slick({draggable:!0,centerMode:!0,slidesToShow:3,slidesToScroll:1,autoplay:!0,dots:!0,speed:2e3,infinite:!0,touchThreshold:100,prevArrow:`<div class="slick-prev">
